...
def consultar_detalle_factura(request):
    if request.method == "POST":
       ...
       if detalle_facturaForm.is_valid():
        ...
        detalle_facturaForm = Detalle_facturaForm()
    return render(request, "detalle_factura/consultar_detalle_factura.html", {'detalle_facturaForm': detalle_facturaForm})
...
def consultar_estado_facturas(request):
    if request.method == "POST":
       ...
       if estado_facturasForm.is_valid():
        ...
        estado_facturasForm = Estado_facturasForm()
    return render(request, "estado_facturas/consultar_estodo_facturas.html", {'estado_facturasForm': estado_facturasForm})
