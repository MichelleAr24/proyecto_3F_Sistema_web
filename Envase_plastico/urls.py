"""envase_plastico URL Configuration
...
Including another URLconf
    ...
    este archivo es de la aplicacion Envase_plastic0
"""
...
urlpatterns = {
    path('', views.saludo),
    path('jhony/', views.miprimerfuncion),
    ...
    # RUTA PARA EL CRUD DE LA ENTIDAD BODEGA#
